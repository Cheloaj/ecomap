...
import com.ecomap.usuario.data.model.Subscription
import com.ecomap.usuario.data.model.SubscriptionPlan
import com.ecomap.usuario.data.remote.EmailService
...
/**
 * Gestor de suscripciones (ficticio para demo)
 * Guarda el estado PRO/Free del usuario localmente
 */
@Singleton
class SubscriptionManager @Inject constructor(
    ...
    /**
     * Verifica si el usuario tiene suscripción PRO activa
     */
     ...
     */
    fun activateProSubscription(): Boolean {
        return try {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                try {
                    ...
                    if (currentUser != null) {
                        ...
                        Log.w(TAG, "No se pudo obtener el usuario para enviar email")
                    }
                } catch (e: Exception) {
