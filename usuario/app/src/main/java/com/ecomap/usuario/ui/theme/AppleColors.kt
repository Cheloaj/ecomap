...
// 🎨 Paleta de colores estilo Apple - iOS (misma que EcoMap Socio)
object AppleColors {
    ...
    // Semantic UI Colors (aliases para compatibilidad)
    val Background = LightBackground
    val Label = Color(0xFF000000)  // Negro para texto primario
    val SecondaryLabel = Gray1      // Gris para texto secundario
    val Separator = LightGray5      // Líneas separadoras
}
