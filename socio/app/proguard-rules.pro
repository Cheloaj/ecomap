# ================================================================================================
# ECOMAP SOCIO - PROGUARD RULES PARA MÁXIMA SEGURIDAD
# ================================================================================================
...
-keepclassmembers class com.ecomap.socio.BuildConfig {
...
-keep,includedescriptorclasses class com.ecomap.socio.**$$serializer { *; }
-keepclassmembers class com.ecomap.socio.** {
    *** Companion;
}
-keepclasseswithmembers class com.ecomap.socio.** {
...
# ---- MODELOS DE DATOS ----
-keep class com.ecomap.socio.data.model.** { *; }
-keepclassmembers class com.ecomap.socio.data.model.** { *; }
